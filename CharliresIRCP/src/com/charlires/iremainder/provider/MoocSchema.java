...
public class MoocSchema {
    ...
    static
    {
        sURIMatcher.addURI(AUTHORITY, "story", STORY);
        sURIMatcher.addURI(AUTHORITY, "people/#", STORY_ID);
        sURIMatcher.addURI(AUTHORITY, "tag/", TAG);
    ...
    public static class Story {
        ...
        public static final String DATABASE_CREATE_STORY = "" +
                "create table " + TABLE_NAME + " " +
                "(" +
                "" + Cols.ID + " integer primary key autoincrement, " +
                "" + Cols.LOGIN_ID + " INTEGER, " +
                "" + Cols.STORY_ID + " INTEGER, " +
                "" + Cols.TITLE + " TEXT, " +
                "" + Cols.BODY + " TEXT, " +
                "" + Cols.AUDIO_LINK + " TEXT, " +
                "" + Cols.VIDEO_LINK + " TEXT, " +
                "" + Cols.IMAGE_NAME + " TEXT, " +
                "" + Cols.IMAGE_LINK + " TEXT, " +
                "" + Cols.TAGS + " TEXT, " +
                "" + Cols.CREATION_TIME + " INTEGER, " +
                "" + Cols.STORY_TIME + " INTEGER, " +
                "" + Cols.LATITUDE + " REAL, " +
                "" + Cols.LONGITUDE + " REAL" +
                ");";
    ...
    public static class Tags {
        ...
        public static final String DATABASE_CREATE_TAGS = "" +
                "create table " + TABLE_NAME + " " +
                "(" +
                "" + Cols.ID + " integer primary key autoincrement, " +
                "" + Cols.LOGIN_ID + " INTEGER, " +
